...
export const kawaiiProducts: Product[] = [
  {
    ...
    rating: 5,
    reviewCount: 210,
    tags: ['kawaii', 'Razer Quartz'],
    sku: 'KAWA-HSET-RZRKV2',
    stock: 30,
    specs: ['Orejas RGB', 'Micrófono Cardioide', 'Sonido THX Spatial', 'Almohadillas de gel']
  },
    {
    id: 'kawaii-headset-2',
    name: 'Logitech G733 Lightspeed - Lilac',
    category: 'Audifonos',
    price: 629.99,
    ...
    rating: 4,
    reviewCount: 180,
    tags: ['kawaii', 'Logitech Aurora'],
    sku: 'KAWA-HSET-LOGG733',
    stock: 25,
    specs: ['Inalámbrico', 'RGB Frontal', 'Micrófono Blue VO!CE', 'Ultraligero 278g']
  },
  {
    id: 'kawaii-keyboard-1',
    name: 'Razer Huntsman Mini - Quartz',
    category: 'Teclados',
    price: 519.99,
    ...
    sku: 'KAWA-KEYB-RZRHM',
    stock: 40,
    specs: ['60% Layout', 'Switches Ópticos', 'PBT Keycaps', 'RGB Chroma']
  },
    {
    id: 'kawaii-keyboard-2',
    name: 'Logitech G715 TKL - White Mist',
    category: 'Teclados',
    price: 839.99,
    originalPrice: 999.99,
    ...
    reviewCount: 90,
    tags: ['kawaii', 'Logitech Aurora'],
    sku: 'KAWA-KEYB-LOGG715',
    stock: 15,
    specs: ['TKL Inalámbrico', 'RGB per-key', 'Reposamuñecas Nube', 'Switches GX Táctiles']
  },
  {
    id: 'kawaii-mousepad-1',
    name: 'Deskmat Kuromi - Sanrio',
    category: 'Mousepad',
    price: 159.99,
    image: findImage('kawaii-mousepad-1'),
    rating: 5,
    reviewCount: 320,
    tags: ['kawaii', 'Sanrio', 'Kuromi'],
    sku: 'KAWA-PAD-KUROMI',
    stock: 50,
    ...
    name: 'Deskmat Cinnamoroll - Sanrio',
    category: 'Mousepad',
    price: 179.99,
    image: findImage('kawaii-mousepad-2'),
    rating: 5,
    reviewCount: 250,
    tags: ['kawaii', 'Sanrio', 'Cinnamoroll'],
    sku: 'KAWA-PAD-CINNA',
    stock: 45,
  ...
  },
   {
    ...
    category: 'Ratones',
    price: 319.99,
    image: findImage('kawaii-mouse-1'),
    rating: 5,
    reviewCount: 280,
    tags: ['kawaii', 'Razer Quartz'],
    sku: 'KAWA-MOU-RZRVM',
    stock: 40,
    specs: ['Ultraligero 61g', 'Sensor 8500 DPI', 'Switches Ópticos', 'RGB Chroma']
  },
  {
    id: 'kawaii-mouse-2',
    name: 'Logitech G705 - White Mist',
    category: 'Ratones',
    price: 419.99,
    image: findImage('kawaii-mouse-2'),
    rating: 4,
    reviewCount: 130,
    tags: ['kawaii', 'Logitech Aurora'],
    sku: 'KAWA-MOU-LOGG705',
    stock: 35,
    specs: ['Inalámbrico', 'Contorneado', 'RGB Lightsync', 'Ligero 85g']
  },
  {
    id: 'kawaii-case-1',
    name: 'Funda Switch OLED - GeekShare Cat Paw',
    category: 'Case',
    price: 99.99,
    image: findImage('kawaii-case-1'),
    rating: 5,
    reviewCount: 180,
    tags: ['kawaii', 'GeekShare'],
    sku: 'KAWA-CASE-GS-SW',
    stock: 60,
    specs: ['Para Switch OLED', 'TPU suave', 'Diseño Patita de Gato', 'Dockable']
  },
  {
    id: 'kawaii-case-2',
    name: 'Carcasa PS5 - My Melody Skin',
    category: 'Case',
    price: 239.99,
    image: findImage('kawaii-case-2'),
    rating: 5,
    reviewCount: 120,
    tags: ['kawaii', 'Sanrio', 'My Melody'],
    sku: 'KAWA-CASE-MM-PS5',
    stock: 30,
    specs: ['Para PS5 Disco', 'Placas Rígidas', 'Fácil Instalación', 'Licencia Sanrio']
  },
   {
    id: 'kawaii-mic-1',
    name: 'Razer Seiren BT - Quartz',
    category: 'Microfonos',
    price: 419.99,
    ...
    sku: 'KAWA-MIC-RZRBT',
    stock: 33,
    specs: ['Bluetooth', 'Omnidireccional', 'Filtro de ruido IA', 'Para móviles']
  },
  {
    id: 'kawaii-combo-1',
    name: 'Combo Hello Kitty & Friends',
    category: 'Combos Girl Gamer',
    price: 999.99,
    originalPrice: 1249.99,
    image: findImage('kawaii-combo-1'),
    rating: 5,
    reviewCount: 190,
    tags: ['kawaii', 'Sanrio', 'Hello Kitty'],
    sku: 'KAWA-COMBO-HK',
    stock: 10,
    specs: ['Teclado + Mouse', 'Edición Limitada Razer', 'Diseño Hello Kitty', 'RGB Chroma']
  },
];
